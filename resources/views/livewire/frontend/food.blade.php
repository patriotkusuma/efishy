        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Composision</th>
                ...
                @if($foodDatas->count() > 0 )
                    @foreach($foodDatas as $data)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-4">
                                {{($foodDatas->currentpage()-1) * $foodDatas->perpage() + $loop->index + 1}}
                            </td>
                            <th scope="row"
                                class="px-6 py-4 font-medium text-lg text-gray-900 whitespace-nowrap dark:text-white">
                                {{$data->name}}
                            </th>
                            <td class="px-6 py-4">{{$data->size . ' mm'}}</td>
                            <td class="px-6 py-4">
                                @switch($data->type)
                                    @case('floating')
                                        <span
                                ...
                                <div class="w-1/2">
                                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                                        <li class="flex items-center">
                                            ...
                                            Protein : <strong>{{$data->protein . ' %'}}</strong>
                                        </li>
                                        <li class="flex items-center">
                                            <svg class="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0"
                                                 fill="currentColor" viewBox="0 0 20 20"
                                        ...
                                        <li class="flex items-center">
                                            ...
                                            Serat : <strong>{{$data->fiber . ' %'}}</strong>
                                        </li>
                                    </ul>
                                </div>
                                <div class="w-1/2">
                                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                                        ...
                                        <li class="flex items-center">
                                            ...
                                            Kadar Air : <strong>{{$data->moisture . ' %'}}</strong>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 justify-between text-right">
                                ...
                                <button wire:click="removeConfirm({{$data->id}}, '{{$data->name}}')"
