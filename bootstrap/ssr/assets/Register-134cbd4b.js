...
import { Box, Grid, TextField, FormControlLabel, Checkbox, Button, createTheme } from "@mui/material";
...
function Register() {
  ...
  return /* @__PURE__ */ jsxs(EfishyGuest, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Register" }),
    /* @__PURE__ */ jsxs(Box, { xs: 12, component: "form", noValidate: true, onSubmit: submit, sx: { mt: 3, alignItems: "center" }, children: [
      /* @__PURE__ */ jsxs(Grid, { container: true, spacing: 2, children: [
        ...
        /* @__PURE__ */ jsx(Grid, { item: true, xs: 12, children: /* @__PURE__ */ jsx(
          FormControlLabel,
          {
            control: /* @__PURE__ */ jsx(Checkbox, { value: "allowExtraEmails", color: "primary" }),
      ...
      /* @__PURE__ */ jsx(Grid, { container: true, justifyContent: "flex-end", children: /* @__PURE__ */ jsx(Grid, { item: true, children: /* @__PURE__ */ jsx(Link, { href: route("login"), variant: "body2", children: "Already have an account? Sign in" }) }) })
    ] })
  ] });
}
export {
